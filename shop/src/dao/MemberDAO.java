...
public class MemberDAO extends JDBConnect {
	...
	public int editMember(String id, String name, String password, String phone, String address, String photoImage) {
		String query = "UPDATE member set id=?, name=? , pw=? ,phone=? ,address=? ,photoImage=? where id= ? ";
		int result = 0;

...
<%@page import="myfileupload.MymyfileDTO"%>
<%@page import="java.util.List"%>
<%@page import="myfileupload.MymyfileDAO"%>
...
<body>
	...
	<%
	MymyfileDAO dao = new MymyfileDAO();
	List<MymyfileDTO> fileLists = dao.myFileList();
	dao.close();
	%>
	<table border="1">
		<tr>

	...
	<form action="../mvcboard/write.do" name="writeFrm" method="post" enctype="multipart/form-data">
		<table border="1" width="90%">
			<tr>
				<td> 작성자 </td>
				<td>
					<input type="text" name="name" style="width:90px;" required>
				</td>
			</tr>
			<tr>
				<td> 제목 </td>
				<td>
					<input type ="text" name = "title" style="width:100px;" required></input>
				</td>
			</tr>
			<tr>
				<td> 내용 </td>
			...
			<tr>
				<td> 첨부파일 </td>
				<td>
					<input type ="file" name = "ofile"></input>
				</td>
			</tr>
			<tr>
				<td> 비밀번호 </td>
				<td>
					<input type ="password" name = "pass" style="width:100px;" required></input>
				</td>
			</tr>
			<tr>
